		...
		<table class="table">
			...
			<tr>
				<td colspan="4" class="text-right">
					<a href="#" class="btn btn-xs btn-dager"></a>
					<a href="" class="btn btn-xs btn-info"></a>
					<a href="../board/list.do" class="btn btn-xs btn-success"></a>
				</td>
			</tr>
			<tr style="display:none">
				<td colspan="4" class="text-right">
				비밀번호:<input type=password id=pwd size=10>
			...
			<tr>
				<td>
					<form method=post action="../board/reply_insert.do">
						...
						<input type=button value="댓글쓰기" style="height:80px;float:left"
